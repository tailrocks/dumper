...
abstract class AbstractTest {
    ...
    @Inject
    lateinit var exportDeclarationRepository: ExportDeclarationRepository

    @Inject
    lateinit var exportItemRepository: ExportItemRepository

    @Inject
    lateinit var passwordEncoder: PasswordEncoder

    @Inject
    lateinit var dataTestService: DataTestService
